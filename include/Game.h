...
class Game
{
    ...
    public:
        ...
        void update(const int &GameType);
        bool collides(const int &GameType);
        void checkLines();
        void draw(SDL_Renderer* &renderer,const int &GameType);
        void gameloop(SDL_Renderer* &renderer,const int &GameType);
